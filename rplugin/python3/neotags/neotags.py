...
from .utils import (do_set_base, do_remove_base, find_tags, strip_c, tokenize,
                    bindex)
...
# Yes C binary
    ...
    def _bin_get_tags(self, files, ft):
        ...
        # try:
        #     ignored_tags = self.vv('ignored_tags#%s' % ft)
        #     ignored_tags = SEPCHAR.join(ignored_tags) if ignored_tags else ''
        # except NvimError:
        #     ignored_tags = ''
