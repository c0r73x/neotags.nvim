...
message_strm(lzma_ret code)
{
    switch (code) {
        ...
        case LZMA_UNSUPPORTED_CHECK:
            return "Unsupported type of integrity check; not verifying file integrity";

        case LZMA_GET_CHECK:
            return stringify(LZMA_GET_CHECK);
        ...
        case LZMA_PROG_ERROR:
            return stringify(LZMA_PROG_ERROR);

        case LZMA_SEEK_NEEDED:
            return stringify(LZMA_SEEK_NEEDED);
    }
